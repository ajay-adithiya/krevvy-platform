  ...
  return (
    <div className="space-y-4 border-t pt-6">
      <div className="flex items-center justify-between">
        ...
        <Button type="button" size="sm" onClick={() => handleOpen()}><Plus className="w-4 h-4 mr-2" /> Add Specification</Button>
      </div>
          ...
          {specifications.map((s) => (
            <div key={s.id} className="flex items-center justify-between p-3 border rounded-md bg-card">
              ...
              <div className="flex gap-2">
                <Button type="button" size="icon-sm" variant="ghost" onClick={() => handleOpen(s)}>
                  <Edit2 className="w-4 h-4" />
                </Button>
                <Button type="button" size="icon-sm" variant="ghost" className="text-destructive" onClick={() => handleDelete(s.id)}>
