...
export default function Hero({ onViewProductsClick, onSearch }: HeroProps) {
  ...
  const { data: homeContent, loading } = useFetch(api.getHomeContent);
  ...
  // Safe empty states if content doesn't exist
  if (!homeContent) {
    return (
      <section className="relative min-h-[50vh] flex flex-col justify-center items-center overflow-hidden px-6 md:px-12 bg-surface dark:bg-[#0a0a0a] transition-colors duration-500 pt-24 pb-16 md:py-0">
         <p className="text-secondary dark:text-neutral-500">Welcome. Content is currently empty.</p>
      </section>
    );
  }
        ...
        <div className="md:col-span-5 flex flex-col items-start z-20 text-left">
          ...
          {homeContent.heroTitle && (
            <motion.h1
              ...
              dangerouslySetInnerHTML={{ __html: homeContent.heroTitle.replace(/\n/g, '<br />') }}
            />
          )}
          ...
          {homeContent.heroSubtitle && (
            <motion.p
              ...
              className="mt-6 font-sans text-base md:text-lg text-tertiary dark:text-neutral-400 max-w-md leading-relaxed whitespace-pre-wrap"
            >
              {homeContent.heroSubtitle}
            </motion.p>
          )}
          ...
          {homeContent.heroCtaLabel && (
            ...
            >
              ...
              >
                <span>{homeContent.heroCtaLabel}</span>
          ...
          <div className="md:col-span-7 relative h-[380px] sm:h-[480px] md:h-[650px] lg:h-[750px] w-full mt-6 md:mt-0 flex justify-center items-center">
            ...
            >
              <img
                ...
                src={homeContent.heroMedia.url}
                alt={homeContent.heroMedia.altText || ""}
